...
function PublicWinnerSwitch(props: any) {
  ...
  return (
    <>
      ...
      <div className={classes.formDescription}>Users will not see Campaigns while the campaign is in the hidden state</div>
...
export default withRouter(PublicWinnerSwitch);
