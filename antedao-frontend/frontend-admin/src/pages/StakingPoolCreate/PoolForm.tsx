...
import { updatePool } from "../../request/staking-pool";
...
import PoolTokenPrice from "./Components/PoolTokenPrice";
...
function PoolForm(props: any) {
  ...
  const [needValidate] = useState(false);
