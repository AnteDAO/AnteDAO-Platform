		...
		<>
			<div className={styles.loginErrorBanner}>
				...
				<span className={styles.loginErrorBannerText}>
					Please change to correct network (Accepted networks:{" "}
					{NETWORK_ETH_NAME} and {NETWORK_BSC_NAME} and {NETWORK_POLYGON_NAME}).{" "}
					Current Network: {CHAIN_ID_NAME_MAPPING[currentNetworkId]} (
					{currentNetworkId})
				</span>
			</div>
		</>
