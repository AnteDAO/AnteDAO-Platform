...
const useCommonStyle = makeStyles((theme: any) => {
  return {
    ...
    nnb2832d: {
      font: 'normal normal 700 28px/32px var(--fontFamily)',
    },
    nnb1824d: {
    ...
    nnb1418d: {
      font: 'normal normal 700 14px/18px var(--fontFamily)',
    },
    nnb1214d: {
    ...
    nnn1827h: {
      font: 'normal normal 400 18px/27px var(--fontFamily)',
    },
    nnn1424h: {
      font: 'normal normal 400 16px/24px var(--fontFamily)',
    },
    nnn1218h: {
      font: 'normal normal 400 12px/18px var(--fontFamily)',
    },
