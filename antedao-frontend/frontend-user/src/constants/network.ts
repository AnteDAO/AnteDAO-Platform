...
export const BUSD_ADDRESS = process.env.REACT_APP_BUSD_SMART_CONTRACT;

export const ANTE_POLYGON_ADDRESS = process.env.REACT_APP_ANTE_POLYGONSMART_CONTRACT  ;
...
export const BUSD_POLYGON_ADDRESS = process.env.REACT_APP_BUSD_POLYGON_SMART_CONTRACT;

export const ANTE_BSC_ADDRESS = process.env.REACT_APP_ANTE_BSC_SMART_CONTRACT;
...
export const APP_NETWORKS: {[key in APP_NETWORKS_NAME]: NetworkInfo } = {
  ...
  [APP_NETWORKS_NAME.BSC]: {
    ...
    id: BSC_CHAIN_ID ,
    icon: "/images/bsc.svg",
    disableIcon: "/images/imagesbinance-disabled.svg"
  },
...
export const APP_NETWORKS_SUPPORT: {[key: number]: NetworkInfo } = {
  ...
  [BSC_CHAIN_ID]: {
    ...
    id: BSC_CHAIN_ID ,
    icon: "/images/bsc.svg",
    disableIcon: "/images/imagesbinance-disabled.png",
    currency: 'BNB',
