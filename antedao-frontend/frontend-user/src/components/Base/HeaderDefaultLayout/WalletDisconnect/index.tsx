      ...
      <DialogContent className={styles.dialogContent}>
        <div className={styles.accountDetails}>
          <div className={styles.accountDetailsIcon}>
            <img alt="logo" src="images/logo-red-kite.svg" style={{ width: '100%' }}/>
          </div>
          <div className={styles.accountDetailBlocks}>
            <div className={styles.accountDetailBlock}>
              ...
              <p className={styles.accountDetailBlockText}>{balance} {networkInfo.currency}</p>
            </div>
            <div className={styles.accountDetailBlock}>
              <span className={styles.accountDetailBlockLabel}>
                Network
              </span>
              <p className={styles.accountDetailBlockText}>{networkInfo.networkName}</p>
            </div>
            <div className={styles.accountDetailBlock}>
              <span className={styles.accountDetailBlockLabel}>
                Wallet
