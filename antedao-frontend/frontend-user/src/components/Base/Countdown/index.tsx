  ...
  return (
    <div id="countdown">
      <ul className={styles.listCountDown}>
        <li style={{width:'100%'}} className={styles.countdownPart + ' number'}>
          <span id="days">{day}</span>
          <span className={styles.countdownInfo}>Days</span>
        </li>
        <li className={styles.countdownParts}>:</li>
        <li style={{width:'100%'}} className={styles.countdownPart + ' number'}>
        ...
        <li style={{width:'100%'}} className={styles.countdownPart + ' number'}>
          ...
          <span className={styles.countdownInfo}>Minutes</span></li>
        <li className={styles.countdownParts}>:</li>
        <li style={{width:'100%'}} className={styles.countdownPart + ' number'}>
          <span id="seconds">{second}</span>
          <span className={styles.countdownInfo}>Seconds</span></li>
      </ul>
    </div>
  )
}
