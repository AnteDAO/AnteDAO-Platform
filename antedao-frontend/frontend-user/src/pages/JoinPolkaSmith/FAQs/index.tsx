...
const fqaList = [
    ...
    {
        title: "Are PKS and ANTE different?",
        content: <p>Yes, PKS and ANTE are two separate tokens.<br/><br/>
            ANTE is the native token of PolkaFoundry, while PKS is the native token of PolkaSmith. But please note that PolkaSmith is PolkaFoundry sister/ canary chain on Kusama.</p>
    },
    {
        ...
        content: <p>(1) Again, it is a standard practice of almost all parachains.<br/>
            ...
            (3) In addition, we found that independent tokens give us the necessary resources. We could use the ANTE budget to run Polkasmith (migrating tokens), and that is what we intend to do initially. But it turns out that Kusama auction is so costly. Suppose we spend like 10% total supply of ANTE on this; there will be not much remaining for Polkadot auction later. So generating a new token is the only way we can win both Kusama and Polkadot parachain slots.</p>
    },
    {
    ...
    {
        title: "Will PKS take the spotlight away from ANTE?",
        content: <p>In the short term, when Kusama auction is running, you will feel PKS took some spotlight away from ANTE. But when Polkadot parachain auction opens a few months from now, ANTE will shine.</p>
    },
    {
    ...
    {
        title: "How will ANTE holders benefit from the introduction of PKS and PolkaSmith bidding for Kusama auction ?",
        content: <p>Winning Kusama parachain is a critical step to PolkaFoundry as we explained above. That is why we have to benefit KSM staker (the ones who help us win parachain).<br/><br/>
            But winning KSM parachain will validate our technology and thus bring trust and value to PolkaFoundry. Therefore, it will benefit ANTE token holders eventually.</p>
    },
    {
        ...
        content: <p>Red Kite Point is not a token; it is just a unique point on our launchpad, Red Kite.<br/><br/>
            Each Red Kite point is equivalent to 1 ANTE staked on Red Kite. Even if you don't stake any ANTE on Red Kite, you can get the same tier benefits.<br/><br/>
    ...
    return (
        <div className={styles.askedQuestions}>
                            ...
                            <div className={styles.questionItem} key={index}>
                                <div onClick={() => {
                                    ...
                                    <div style={{display: "inline-block", textAlign: "right"}}>
                                        <img alt="question" className={styles.navQuestion} src={iconUP} width={15} height={8}
            ...
            <div onClick={() => {
                ...
                <img alt="scroll to top" width={32} height={32} src={arrowUp}/>
                <h3>Back to top</h3>
            </div>
        </div>
    );
