        ...
        <ul className={styles.listItem}>
          <li className={styles.Item}>
            ...
            <div className={styles.groupItem}>
              ...
              <div className={styles.valueItem}>
                {data?.staked?.amount ? numberWithCommas(data?.staked?.amount?.toString()) : '0'} ANTE
              </div> 
            </div>
          </li>
          <li className={styles.Item}>
            ...
            <div className={styles.groupItem}>
              ...
              <div className={styles.valueItem}>
                {data?.unstaked ? numberWithCommas(unstakedTotal.toString()) : '0'} ANTE
              </div>
            </div>
                      ...
                      <li className={styles.itemUnstake} key={i}>
                        ...
                        <div className={styles.groupItem}>
                          ...
                          <div className={styles.valueItemUnstake}>
                            ...
                            /
                            {item_unstaked?.unstakedAmount ? numberWithCommas(item_unstaked?.unstakedAmount?.toString()) : '0'} ANTE
                          </div>
                        </div>
                        <div className={styles.groupItem}>
                          <div className={styles.nameItemUnstake}>Remaining Unstake Value</div>
                          <div className={styles.valueItemUnstake}>
                            {item_unstaked?.remainingAmount ? numberWithCommas(item_unstaked?.remainingAmount?.toString()) : '0'} ANTE
                          </div>
                        </div>
                      </li>
                    )
          ...
          <li className={styles.Item}>
            <div className={styles.groupItem}>
              ...
              <div className={styles.valueItem}>
                {data?.balance ? numberWithCommas(data?.balance?.toString()) : '0'} ANTE
              </div> 
            </div>
            <div className={styles.groupItem}>
              <div className={styles.nameItem}>
