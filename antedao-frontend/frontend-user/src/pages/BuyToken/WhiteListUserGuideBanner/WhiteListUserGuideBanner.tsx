  ...
  return (
    <>
      ...
      <div className={styles.poolWhitelistGuide} style={{  }}>
        ...
        <div className={styles.poolWhiteListLineSmall}>
          Please fill out the &nbsp;
          <a style={{ color: '#1a73e8', textDecoration: 'underline' }} href={poolDetails.whitelistBannerSetting.whitelist_link} target={'_blank'} rel="noreferrer">whitelist form</a>&nbsp;
        ...
        <div className={styles.poolWhiteListLineSmall}>
          ...
          <a style={{ color: '#1a73e8', textDecoration: 'underline' }} href={poolDetails.whitelistBannerSetting.guide_link} target={'_blank'} rel="noreferrer">here</a>.
        </div>
