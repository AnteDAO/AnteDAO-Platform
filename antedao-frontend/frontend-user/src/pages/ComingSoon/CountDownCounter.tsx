...
const CountDownCounter = (props: any) => {
    ...
    return (
      <>
        <div className={`${styles.timeWrapper}`}>
          <div className={`${styles.timeText} ${props.customItem}`}>
            {time < 10 ? "0" + time : time}
          </div>
          <div className={`${styles.timeDimension} ${props.childItem}`}>
            {dimension}
          </div>
        </div>
      </>
  ...
  // @ts-ignore
  return (
    <div className={`${styles.timers} ${props.customClass}`}>
