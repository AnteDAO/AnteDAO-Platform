...
const ModalDeposit = (props: any) => {
  ...
  const onDeposit = () => {
    ...
    dispatch(deposit(connectedAccount, depositAmount, library, process.env.REACT_APP_ANTE as string));
    setOpenModalTransactionSubmitting(true);
    setOpenModalDeposit(false);
  }

  const onApprove = () => {
    dispatch(approve(connectedAccount, library, process.env.REACT_APP_ANTE as string));
    setOpenModalTransactionSubmitting(true);
    setOpenModalDeposit(false);
  }
