...
const ModalWithdraw = (props: any) => {
  ...
  const onWithDraw = () => {
    ...
    dispatch(withdraw(connectedAccount, withdrawAmount, library, process.env.REACT_APP_ANTE as string));
      ...
      <div className={commonStyles.modal + ' ' + styles.modalWithdraw}>
        <div className="modal-content">
          <div className="modal-content__head">
            <img alt='Close modal' src={closeIcon} className="btn-close" onClick={handleClose}/>
          ...
          <div className="modal-content__body">
            ...
            <div className="input-group">
              <input
                ...
                onChange={(e: any) => (e.target.value === '' || REGEX_NUMBER.test(e.target.value)) && setWithdrawAmount(e.target.value)}
                placeholder="0.00"
              />
              <div>
