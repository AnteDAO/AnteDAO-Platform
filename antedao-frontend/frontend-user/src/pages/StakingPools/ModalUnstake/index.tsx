      ...
      <div className="modal-content">
        ...
        <DialogContent className="modal-content__body">
          ...
          <div className="token-type">
            ...
            <div className="token-detail">
              <div>{!BigNumber.from(stakingAmount || '0').eq(BigNumber.from('0')) && Number(utils.formatEther(stakingAmount)).toFixed(2)}</div>
            </div>
          </div>
          <div className="token-type">
            <div>
            ...
            <div className="token-detail">
            <div>{!BigNumber.from(pendingReward || '0').eq(BigNumber.from('0')) && Number(utils.formatEther(pendingReward)).toFixed(2)}</div>
            </div>
          </div>
          {
