...
class UserDeviceService {
  async subscribeNotification(wallet_address, subscribe_status, player_id) {
    ...
    if(userDevice){
      ...
      newUserDevice.user_id = isExistedUser.id;
      newUserDevice.player_id = player_id;
      newUserDevice.login_status = true;
      newUserDevice.login_at = new Date();
      newUserDevice.subscribe_status = true;
