...
class WhiteListUserController {
  ...
  async getParticipants({ request }) {
    ...
    /**
  * @swagger
  * /admin/pool/{campaignId}/participants/{walletAddress}/delete:
  *   delete:
  *     tags:
  *       - join campain 
  *     summary: delete user in whitelist  
  *     parameters:
  *       - name: campaignId
  ...
  *     responses:
  *       200:
  *         description: lotery winner from whitelist
  *         example:
  */
  ...
  /**
  * @swagger
  * /admin/pool/winner-random/{campaignId}/{tier}:
  *   post:
  *     tags:
  *       - winner list api 
  *     summary: lotery winner from whitelist 
  *     parameters:
  *       - name: campaignId
  *         description: campaignId
  *         in: path
  ...
  *         type: number
  *       - name: tier
  *         description: tier which want lotery 
  *         in: path
  *         required: true
  *         type: number
  *       - name: number
  *         description: max number winner of thos lotery 
  *         in: query
  *         required: true
  *         type: number
  *     responses:
  ...
  */
  ...
  async getRandomWinners({ request }) {
    ...
    /**
  * @swagger
  * /user/whitelist-search/{campaignId}:
  *   get:
  *     tags:
  *       - User
