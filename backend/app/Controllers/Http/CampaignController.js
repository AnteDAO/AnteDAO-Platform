...
class CampaignController {
  ...
  *     tags:
  *       - Campaign admin 
  *     summary: get campaign-latest-active( deposit claim ...)
  *     parameters:
  *       - name: jwtPayload
  *         description: jwtPayload
  *         in: header
  *         required: true
  *         type: string
  *       - name: limit
  ...
  *         type: number
  *       - name: title
  *         description:  search term for title or symbol( if title is active or suspend => check pool is pause or not)
  *         in: query
  *         required: false
  *         type: string
  *       - name: start_time
  *         description:  start_time of campaign 
  *         in: query
  *         required: false
  *         type: number
  *       - name: finish_time
  *         description:  finish_time of campaign 
  *         in: query
  *         required: false
  *         type: number
  *       - name: registed_by
  *         description:  register of campaign 
  *         in: query
  *         required: false
  *         type: string
  ...
  *     responses:
  *       200:
  *         description:  get campaign-latest-active( deposit claim ...)
  *         example:
  */
  ...
  *         type: string
  *       - name: campaign
  *         description: campaign id ( or campaign_hash)
  *         in: path
  *         required: true
  *         type: string
  ...
  *     tags:
  *       - Campaign admin 
  *     summary: get newest campaign deploy
  *     parameters:
  *       - name: jwtPayload
  *         description: jwtPayload
  *         in: header
  ...
  *     responses:
  *       200:
  *         description:  get newest campaign deploy
  *         example:
  */
  ...
  */
  ...
  async myCampaign({ request, auth }) {
    ...
    /**
  * @swagger
  * /user/check-canceled-campaign:
  *   get:
  *     tags:
  *       - join campain 
  *     summary: user  join-campaign. remove from submission and whitelist, remove from winnerslist and reserved list if in . After that save in cancel whitelist
  *     parameters:
  *       - name: campaign_id
  ...
  *     responses:
  *       200:
  *         description:  check user had cancel join campain 
  *         example:
  */
  ...
  *     tags:
  *       - join campain 
  *     summary: user join-campaign ( apply whitelisst submiss )
  *     parameters:
  *       - name: campaign_id
  *         description: campaignId
  *         in: query
  ...
  */
  ...
  async joinCampaign({ request }) {
    ...
    try {
      ...
      if (user.is_kyc != Const.KYC_STATUS.APPROVED&& camp.kyc_bypass===1) {
  ...
  *     tags:
  *       - buy token
  *     summary:  deposit token ( buy ido token wwith other token)  
  *     parameters:
  *       - name: campaign_id
  *         description: campaignId
  *         in: query
  ...
  *     responses:
  *       200:
  *         description:  return max buy min buy of user and signature encode to FE to  call Smart contract( in wallet FE)
  *         example:
  */
  ...
  /**
  * @swagger
  * /user/counting/{campaignId}:
  *   get:
  *     tags:
  *       - join campain  
  *     summary: counting number user join campain 
  *     parameters:
  *       - name: campaignId
  *         description: campaignId
  *         in: path
  ...
  *     responses:
  *       200:
  *         description: counting number user join campain
  *         example:
  */
  ...
  /**
  * @swagger
  * /user/check-join-campaign/{campaignId}:
  *   get:
  *     tags:
  *       - join campain 
  *     summary: check user join-campaign ( apply whitelisst submiss )
  *     parameters:
  *       - name: campaign_id
  *         description: campaignId
  *         in: query
  ...
  *     responses:
  *       200:
  *         description:  return max claimable and signature encode to FE call in wallet 
  *         example:
  */
  async claim({ request }) {
    // get all request params
