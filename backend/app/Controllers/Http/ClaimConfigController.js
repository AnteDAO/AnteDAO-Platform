...
class ClaimConfigController {
  ...
  /**
  * @swagger
  * /pool/{campaignId}/claim-configs:
  *   get:
  *     tags:
  *       - claim token 
  *     summary: get claim-configs
  *     parameters:
  *       - name: campaignId
  ...
  *     responses:
  *       200:
  *         description: claim-configs of campaign
  *         example:
  */
  ...
  /**
  * @swagger
  * /pool/{campaignId}/user/{walletAddress}/claimable-amount:
  *   get:
  *     tags:
  *       - claim token 
  *     summary: get claimable-amount of user in this campain
  *     parameters:
  *       - name: campaignId
  *         description: campaignId
  *         in: path
  ...
  *     responses:
  *       200:
  *         description: get claimable-amount of user in this campain
  *         example:
  */
