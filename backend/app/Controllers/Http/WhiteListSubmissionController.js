...
class WhiteListSubmissionController {
  /**
  * @swagger
  * /user/whitelist-apply/{campaignId}:
  *   get:
  *     tags:
  *       - join campain 
  *     summary: get WhiteList Submission by wallet_address or campaignId
  *     parameters:
  *       - name: campaignId
  ...
  *     responses:
  *       200:
  *         description: list get WhiteList Submission by wallet_address or campaignId
  *         example:
  */
  ...
  *     tags:
  *       - whitelist api
  *     summary: get whitelist submission
  *     parameters:
  *       - name: campaignId
  *         description: campaignId
  *         in: path
  ...
  *     responses:
  *       200:
  *         description: list whitelist_submissions but not in whitelist
  *         example:
  */
  ...
  *     tags:
  *       - join campain 
  *     summary: get user previous whitelist_submissions 
  *     parameters:
  *       - name: wallet_addresses
  *         description:  wallet_addresses
  *         in: path
  *         required: true
  *         type: string 
  *     responses:
  *       200:
  *         description: get user previous whitelist_submissions
  *         example:
  */
  ...
  *     tags:
  *       - whitelist api
  *     summary: get previous whitelist submission
  *     parameters:
  *       - name: wallet_address
  *         description: wallet address input
  *         in: query
  ...
  */
  ...
  /**
  * @swagger
  * /admin/pool/{campaignId}/participants:
  *   get:
  *     tags:
  *       - join campain 
  *     summary: get Remain Participants(whitelist_submissions but not in whitelist)
  *     parameters:
  *       - name: campaignId
  *         description: campaignId
  *         in: path
  ...
  *     tags:
  *       - join campain 
  *     summary: add WhiteList Submission 
  *     parameters:
  *       - name: campaignId
  *         description: campaignId
  *         in: path
  ...
  *         type: string
  *       - name: user_telegram
  *         description: user_telegram
  *         in: query
  *         required: true
  *         type: string
  *       - name: user_twitter
  *         description: user_twitter
  *         in: query
  *         required: true
  *         type: string
  *       - name: msgsignature
  *         description: message send to user wallet to sign
  *         in: header
  *         required: true
  *         type: string
  *       - name: signature
  *         description: signature sign by wallet from message
  *         in: query
  *         required: true
  *         type: string
  ...
  *     responses:
  *       200:
  *         description: add WhiteList Submission
  *         example:
  */
    ...
    try {
      ...
      if(camp.kyc_bypass !== 0 ){
        if (user.is_kyc != Const.KYC_STATUS.APPROVED) {
          ...
          return HelperUtils.responseBadRequest("You must register for KYC successfully to be allowed to join. Or the email address and/or wallet address you used for KYC does not match the one you use on AnteDao. Please check and update on Blockpass to complete KYC verification.");
        }
      }
  ...
  /**
  * @swagger
  * /admin/pool/{campaignId}/whitelist-submission/{walletAddress}:
  *   put:
  *     tags:
  *       - join campain 
  *     summary: update  whitelist_submissions 
  *     parameters:
  *       - name: campaignId
  *         description: campaignId
  *         in: path
  ...
  *         description:  self_twitter_status
  *         in: query
  *         required: false
  *         type: number 
  *       - name: self_group_status
  *         description:  self_group_status
  *         in: query
  *         required: false
  *         type: number 
  *       - name: self_channel_status
  *         description:  self_channel_status
  *         in: query
  *         required: false
  *         type: number 
  *       - name: self_retweet_post_status
  *         description:  self_retweet_post_status
  *         in: query
  *         required: false
  *         type: number 
  *       - name: partner_twitter_status
  *         description:  partner_twitter_status
  *         in: query
  *         required: false
  *         type: number 
  *       - name: partner_group_status
  *         description:  partner_group_status
  *         in: query
  *         required: false
  *         type: number 
  *       - name: partner_channel_status
  *         description:  partner_channel_status
  *         in: query
  *         required: false
  *         type: number 
  *       - name: partner_retweet_post_status
  *         description:  partner_retweet_post_status
  *         in: query
  *         required: false
  *         type: number 
  ...
  *     responses:
  *       200:
  *         description: update  whitelist_submissions
  *         example:
  */
  ...
  async updateWhitelistSubmission({ request, params }) {
    ...
    try {
      ...
      /**
  * @swagger
  * /admin/pool/{campaignId}/whitelist-submission/{wallet_addresses}/verify:
  *   post:
  *     tags:
  *       - join campain 
  *     summary: verify  whitelist_submissions 
  *     parameters:
  *       - name: campaignId
  *         description: campaignId
  *         in: path
  ...
  *     responses:
  *       200:
  *         description: verify  whitelist_submissions
  *         example:
  */
  ...
  /**
  * @swagger
  * /admin/pool/{campaignId}/whitelist-submission/batch/verify:
  *   post:
  *     tags:
  *       - join campain 
  *     summary: verify list whitelist_submissions 
  *     parameters:
  *       - name: campaignId
  *         description: campaignId
  *         in: path
  ...
  *         type: string
  *       - name: wallet_addresses
  *         description: list wallet_addresses
  *         in: body
  *         required: true
  *         schema:
  *            type: object
  ...
  */
  ...
  async verifyBatchWhitelistSubmission({ request, params }) {
    ...
    /**
  * @swagger
  * /admin/pool/{campaignId}/whitelist-submission/batch/approve:
  *   post:
  *     tags:
  *       - join campain 
  *     summary: approve list whitelist_submissions 
  *     parameters:
  *       - name: campaignId
  *         description: campaignId
  *         in: path
  ...
  *     responses:
  *       200:
  *         description: approve list whitelist_submissions
  *         example:
  */
